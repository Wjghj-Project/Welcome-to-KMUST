...
## 用于游戏内文本的字体。
define gui.text_font = "SourceHanSansCN-Medium.ttf"

## 用于角色名称的字体。
define gui.name_text_font = "SourceHanSansCN-Medium.ttf"

## 用于游戏外文本的字体。
define gui.interface_text_font = "SourceHanSansCN-Medium.ttf"
